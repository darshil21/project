...
$sql="select * from user_tbl where email='".$id."' and token='".$token."'";
$res=$cnn->query($sql);
if($res->num_rows==1)
{
    $sql="update user_tbl set verify='yes' where email=".$id;
}
echo '<a href="login.php">'.'Click here to Confirm Login'.'</a>';
