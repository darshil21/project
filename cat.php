...
while($row=$result->fetch_assoc())
{
    ...
    echo '<td>' . $row["cat_name"] . '</td>';
     echo '<td><a href="cupdate.php?id='.$row["cat_id"].'"><span class="glyphicon glyphicon-pencil"></span> | <a href="cdelete.php?id='.$row["cat_id"].'"><span class="glyphicon glyphicon-remove"> </td>';
}
?>
</table>
